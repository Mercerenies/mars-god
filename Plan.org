...
** IM the DM (IMTDM)
   Message "Mercer" in instant messaging
* SCRIPT
** INTRO
   + Mars: "Greetings! I am Mars, god of war!"
   + Boss: "Oh, you must be the new intern. You know we have a dress code, right?"
   + Boss: "Eh, whatever. Your computer is over there. Get logged in and I'll send you a message with some instructions."
   + (cut to screen)
   + Mars: "What is this strange box?"
   + Mars: "By Jupiter, the display is alit!"
   + Mars: "When I maneuver this small rodent, the display responds in kind."
** AUDIO FILE
   + Minerva: "Listen to me, Mars! There isn't much time! You need to go back to RomanGods.com and log in. There's important information over there."
** BAD ENDING
   + Mars: "Gah! What a horrible nightmare!"
   + Minerva: "It's okay, Mars, you're awake now."
   + Minerva: "Your computer is over there. Get logged in and I'll send you a message with some instructions."
   + Mars: "Nooooooooo!"
** GOOD ENDING
   + Mars: "Gah! What a horrible nightmare!"
   + Minerva: "It's okay, Mars, you're awake now. You're free. We're all free."
   + Mars: "We did it!"
   + Mars: "Thank you for playing!"
