...
** STAGE 15
   Minerva messages you once again. She tells you something is keeping
   you there. A dark, malevolent entity called a "stapler". You need
   to defeat this entity by clicking on it repeatedly. Of course, this
   is talking about Stapley the Stapler, who is actually the final
   boss of the game. Click on Stapley several times, and he'll get
   angry, trying to consume the screen. Continue clicking to win the
   game.
* SOFTWARE
** DISCO YABBER
   Instant messaging service
** MACROSOFT OFFICE (LETTER / EXCEED / POWERLINE)
   Office suite (Stapley the Stapler)
** FIREDOG
   Web browser
** MAIL
** CALCULATOR
